...
case "$PRETTYpretty" in
  *Ubuntu*)
    ...
    wget -N https://armorscripts.s3.amazonaws.com/BASHscripts/bashrc.txt -O ~/.bashrc 2>/dev/null
  ...
  *Debian*)
    wget -N https://armorscripts.s3.amazonaws.com/BASHscripts/ansiart/ascii-art-debian.ans 2>/dev/null
